...
export class SharedServiceService {
  cardData: any = [
    {
      hind: 'SPORTS BASED',
      name: 'SUPER KINGS ACADEMY',
      imageUrl: './assets/images/sportsruler.png',
      website: 'https://superkingsacademy.com/',
    ...
    },
    {
      ...
      website: '', // Mobile App - Not deployed
    ...
    },
    {
      ...
      website: 'https://uat.freightpay-admin.flexcappro.com/',
